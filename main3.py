...
def main():
    ...
    optimizer = optim.SGD(model.parameters(), lr=0.01, momentum=0.9, weight_decay=1e-5)  # 가중치 감쇠 추가

    # 모델 딕셔너리를 사용하여 각 모델에 대한 훈련 및 평가 진행
    model_name = "LeNet-5"  # 또는 CustomMLP
    ...
    for epoch in range(1, 3):  # 10 에폭까지 실행
